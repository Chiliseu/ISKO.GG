...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let shapes = new Map(); // Track all active shapes with their start times
        ...
        function createShape() {
            ...
            // Store shape data with timestamp
            shapes.set(shape, {
                startTime: Date.now(),
                size: size,
                fallSpeed: 120 // pixels per second
            });
        }
        ...
        function updateShapes() {
            ...
            shapes.forEach((data, shape) => {
                const elapsed = (currentTime - data.startTime) / 1000; // seconds
                const newY = elapsed * data.fallSpeed - 50; // start from -50px
                
                shape.style.top = `${newY}px`;
                
                // Check if shape hit the ground
        ...
        setInterval(() => {
            const currentTime = Date.now();
            if (currentTime - lastShapeTime >= 200) { // Create 5 shapes per second
                createShape();
        ...
        updateShapes();
                ...
                // Summarize button handler and modal logic
                document.getElementById("summarize-button").addEventListener("click", () => {
                    ...
                    .then(data => {
                        ...
                        document.getElementById("summary-image").src = data.image_url || "";
    ...
    <div class="modal-content">
        ...
        <img id="summary-image" src="" alt="Game Image" style="max-width: 100%; border-radius: 10px;">
        <p id="summary-text"></p>
    </div>
</div>
